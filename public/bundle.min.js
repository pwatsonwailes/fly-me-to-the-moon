...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var _createClass=function(){function e(e,t){for(var a=0;a<t.length;a++){var r=t[a];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,a,r){return a&&e(t.prototype,a),r&&e(t,r),t}}();Object.defineProperty(exports,"__esModule",{value:!0});var _react=require("react"),_react2=_interopRequireDefault(_react),_air_ground=require("../json/air_ground.json"),_air_ground2=_interopRequireDefault(_air_ground),_flight_director=require("../json/flight_director.json"),_flight_director2=_interopRequireDefault(_flight_director),_descent=require("../json/descent.json"),_descent2=_interopRequireDefault(_descent),MoonLanding=function(e){function t(){_classCallCheck(this,t);var e=_possibleConstructorReturn(this,Object.getPrototypeOf(t).call(this));return e.togglePlayback=e.togglePlayback.bind(e),e.toggleVolume=e.toggleVolume.bind(e),e.onPlayStart=e.onPlayStart.bind(e),e.onProgress=e.onProgress.bind(e),e.handleTimeChange=e.handleTimeChange.bind(e),e.handleBookmarkTimeChange=e.handleBookmarkTimeChange.bind(e),e.handleResize=e.handleResize.bind(e),e.renderControls=e.renderControls.bind(e),e.renderStats=e.renderStats.bind(e),e.renderComms=e.renderComms.bind(e),e.renderCommsList=e.renderCommsList.bind(e),e.renderBookmark=e.renderBookmark.bind(e),e.state={ga:[],fd:[],a:{},s:{},playing:!1,currentTime:0,loaded:0,played:0},e}return _inherits(t,e),_createClass(t,[{key:"componentDidMount",value:function(){this.refs.audio.addEventListener("timeupdate",this.onProgress),this.refs.audio.addEventListener("progress",this.onProgress),this.refs.audio.addEventListener("playing",this.onPlayStart),this.refs.audio.addEventListener("ended",this.onEnded),window.addEventListener("resize",this.handleResize),this.handleResize()}},{key:"componentWillUnmount",value:function(){window.removeEventListener("resize",this.handleResize)}},{key:"onProgress",value:function(e){var t="#90d26a",a="#565860",r="#90d26a",n="#7b7d82",i="#90d26a";if(("undefined"==typeof e||e!==!0)&&(e=!1),this.refs.audio.buffered.length>0){var s=this.refs.trackbar.clientWidth,l=this.refs.trackbar.clientHeight,o=this.refs.audio.duration,d=this.refs.audio.currentTime,u=this.refs.trackbar.getContext("2d"),f=o>0?d*(s-1)/o|0:0;if(u.clearRect(0,0,s,l),0>=o)return;for(var c=0,h=0;h<this.refs.audio.buffered.length;h++){var m=this.refs.audio.buffered.start(h)*s/o|0,g=this.refs.audio.buffered.end(h)*s/o|0;m>c&&(f>c&&(u.fillStyle=t,u.fillRect(c,0,Math.min(f-1,m)-c,l)),m>f&&(u.fillStyle=a,u.fillRect(Math.max(f+1,c),0,m,l))),f>m&&(u.fillStyle=r,u.fillRect(m,0,Math.min(f,g)-1-m,l)),g>f&&(u.fillStyle=n,u.fillRect(Math.max(f+1,m),0,g-1,l)),c=g}f>c&&(u.fillStyle=t,u.fillRect(c,0,f-1-c,l)),c=Math.max(f+1,c),s>c&&(u.fillStyle=a,u.fillRect(c,0,s-c,l)),u.fillStyle=i,u.fillRect(Math.max(0,f-1),0,3,l);var _=Math.floor(d),p={ga:this.state.ga,fd:this.state.fd,currentTime:_,loaded:this.refs.audio.buffered.end(0)/this.refs.audio.duration,played:d/this.refs.audio.duration};if(e){p.ga=[],p.fd=[];for(var v=Object.keys(_descent2["default"].altitude),y=Object.keys(_descent2["default"].speed),k=0;k<v.length;k++)if(_>v[k])var b=v[k];for(var k=0;k<y.length;k++)if(_>y[k])var E=y[k];var C=JSON.parse(JSON.stringify(_descent2["default"].altitude[b])),S=JSON.parse(JSON.stringify(_descent2["default"].speed[E]));C.v=C.v+C.r*(_-b),S.v=S.v+S.r*(_-b),p.a=C,p.s=S}else{if(_descent2["default"].altitude[_])p.a=JSON.parse(JSON.stringify(_descent2["default"].altitude[_]));else if(_>this.state.currentTime){var R=this.state.a;R.v=R.v+R.r,p.a=R}if(_descent2["default"].speed[_])p.s=JSON.parse(JSON.stringify(_descent2["default"].speed[_]));else if(_>this.state.currentTime){var P=this.state.s;P.v=P.v+P.r,p.s=P}}if(_>this.state.currentTime){if("undefined"!=typeof _air_ground2["default"][_]){for(var k=0;k<_air_ground2["default"][_].length;k++)p.ga.unshift(_air_ground2["default"][_][k]);for(;p.ga.length>6;)p.ga.pop()}if("undefined"!=typeof _flight_director2["default"][_]){for(var k=0;k<_flight_director2["default"][_].length;k++)p.fd.unshift(_flight_director2["default"][_][k]);for(;p.fd.length>6;)p.fd.pop()}}this.setState(p)}}},{key:"onPlayStart",value:function(){this.setState({played:0,loaded:0})}},{key:"getRelativeLocation",value:function(e){for(var t=e.pageX,a=e.pageY,r=e.target;r;)t-=r.offsetLeft,a-=r.offsetTop,r=r.offsetParent;return{x:t,y:a}}},{key:"handleTimeChange",value:function(e){var t=this.getRelativeLocation(e);this.refs.audio.currentTime=this.refs.audio.duration*t.x/(this.refs.trackbar.clientWidth+1),this.onProgress(!0)}},{key:"handleBookmarkTimeChange",value:function(e){this.refs.audio.currentTime=e.target.dataset.timestamp,this.onProgress(!0)}},{key:"handleResize",value:function(){this.refs.trackbar.setAttribute("height",this.refs.trackbar.clientHeight+"px"),this.refs.trackbar.setAttribute("width",this.refs.trackbar.clientWidth+"px"),this.onProgress()}},{key:"togglePlayback",value:function(e){this.state.playing===!0?(this.refs.audio.pause(),this.setState({playing:!1})):(this.refs.audio.play(),this.setState({playing:!0}))}},{key:"toggleVolume",value:function(e){"1"===e.target.dataset.volup&&this.refs.audio.volume<1?this.refs.audio.volume+=.1:"0"===e.target.dataset.volup&&this.refs.audio.volume>0&&(this.refs.audio.volume-=.1)}},{key:"renderAudio",value:function(){return _react2["default"].createElement("audio",{ref:"audio"},_react2["default"].createElement("source",{src:"/fly-me-to-the-moon/audio/apollo_11_landing.mp3",type:"audio/mpeg"}),_react2["default"].createElement("p",null,"Your browser does not support the audio element."))}},{key:"renderComms",value:function(e){var t=[];if(this.state[e].length>0){for(var a=0;a<this.state[e].length;a++)t[a]=this.renderCommsList(this.state[e][a],e,a);return _react2["default"].createElement("ul",{key:"comms"+e},t)}return t}},{key:"renderCommsList",value:function(e,t,a){return _react2["default"].createElement("li",{key:t+a},e.name+"  ("+e.position+"): "+e.text)}},{key:"renderBookmark",value:function(e){var t=e.t/this.refs.audio.duration*100;return _react2["default"].createElement("li",{key:e.key,"data-timestamp":e.t,title:e.text,onClick:this.handleBookmarkTimeChange,style:{left:t+"%"}},_react2["default"].createElement("i",{className:"fa fa-bookmark","data-timestamp":e.t}))}},{key:"renderControls",value:function(){var e=this.state.playing===!0?"fa fa-pause-circle":"fa fa-play-circle",t=this.refs&&this.refs.audio&&this.refs.audio.duration?_descent2["default"].bookmarks.map(this.renderBookmark):[];return _react2["default"].createElement("div",{className:"audioplayer_controls col col-xs-12"},_react2["default"].createElement("ul",{id:"events_panel"},t),_react2["default"].createElement("canvas",{ref:"trackbar",onClick:this.handleTimeChange}),_react2["default"].createElement("i",{className:e,onClick:this.togglePlayback}),_react2["default"].createElement("i",{className:"fa fa-volume-up","data-volup":1,onClick:this.toggleVolume}),_react2["default"].createElement("i",{className:"fa fa-volume-down","data-volup":0,onClick:this.toggleVolume}))}},{key:"renderStats",value:function(){var e=this.refs&&this.refs.audio&&this.refs.audio.currentTime?this.refs.audio.currentTime:0;if("undefined"!=typeof moment)var t=moment.duration(0|e,"seconds"),a=t.minutes()>9?t.minutes():"0"+t.minutes(),r=t.seconds()>9?t.seconds():"0"+t.seconds(),n=a+":"+r;else var n="00:00";if("undefined"!=typeof moment)var i=moment.duration(905-e|0,"seconds"),s=i.minutes()>9?i.minutes():"0"+i.minutes(),l=i.seconds()>9?i.seconds():"0"+i.seconds(),o=i.seconds()>0?s+":"+l:"00:00";else var o="15:05";var d=this.state.a.v%1===0?"0,0":"0,0.0",u=this.state.s.v%1===0?"0,0":"0,0.0",f="undefined"!=typeof this.state.a.v?numeral(this.state.a.v).format(d):0,c="undefined"!=typeof this.state.s.v?numeral(this.state.s.v).format(u):0;return _react2["default"].createElement("div",{className:"row"},_react2["default"].createElement("div",{className:"col col-xs-3"},_react2["default"].createElement("h3",null,"Altitude"),_react2["default"].createElement("p",null,f+" feet")),_react2["default"].createElement("div",{className:"col col-xs-3"},_react2["default"].createElement("h3",null,"Horizontal Speed"),_react2["default"].createElement("p",null,c+" feet per second")),_react2["default"].createElement("div",{className:"col col-xs-3"},_react2["default"].createElement("h3",null,"Audio Time"),_react2["default"].createElement("p",null,n)),_react2["default"].createElement("div",{className:"col col-xs-3"},_react2["default"].createElement("h3",null,"Time to Landing"),_react2["default"].createElement("p",null,o)))}},{key:"render",value:function(){var e=this.renderAudio(),t=this.renderControls(),a=this.renderStats(),r=this.renderComms("ga"),n=this.renderComms("fd");return _react2["default"].createElement("div",null,e,t,a,_react2["default"].createElement("div",{className:"row"},_react2["default"].createElement("div",{className:"col col-xs-6"},_react2["default"].createElement("h3",null,"CAPCOM/Eagle"),r),_react2["default"].createElement("div",{className:"col col-xs-6"},_react2["default"].createElement("h3",null,"Flight Director COMMs"),n)))}}]),t}(_react2["default"].Component);exports["default"]=MoonLanding;
